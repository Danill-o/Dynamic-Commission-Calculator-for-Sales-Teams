-- ============================================
-- Trigger: TRG_SALE_BEFORE_INSERT
-- Purpose: Enforce DML restrictions on SALE table INSERT operations
-- Trigger Type: BEFORE INSERT (Statement Level)
-- ============================================
CREATE OR REPLACE TRIGGER trg_sale_before_insert
...
BEGIN
    ...
    IF NOT v_is_allowed THEN
        RAISE_APPLICATION_ERROR(
            ...
            'INSERT operations on SALE table are not allowed on ' ||
            CASE 
...
EXCEPTION
    WHEN OTHERS THEN
        -- Log trigger error
        log_audit_event(
            'SALE', 'TRIGGER_ERROR', 'BEFORE_INSERT',
            NULL, NULL, 'ERROR',
            'Trigger error: ' || SQLERRM
        );
        RAISE; -- Re-raise the exception
END trg_sale_before_insert;
/